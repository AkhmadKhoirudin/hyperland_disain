...
# Jalankan wofi - Prompt user untuk memilih
# Menghapus logika auto-kill kursor agar menu tidak menutup sendiri secara tidak sengaja
...
# Tunggu proses wofi selesai (sudah tidak background)
rm -f "$LOCK_FILE"
